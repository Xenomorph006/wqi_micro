...
export default function App() {
  ...
  return (
    <>
      {/* ✅ BACKGROUND VIDEO (mounts ONCE) */}
      <BackgroundVideo />

      {/* ✅ APP CONTENT */}
      <div className="min-h-screen bg-slate-800/45 text-slate-100 font-sans relative z-10">
        {/* NAVBAR */}
          ...
          {page === "home" && (
            <div className="space-y-10 animate-in fade-in duration-700">
              <header className="text-center space-y-2">
                ...
                <p className="text-slate-200/80 text-xl font-lg tracking-tight">
